...
class MambaSISRModel(SRModel):
    ...
    def __init__(self, opt):
        super(MambaSISRModel, self).__init__(opt)
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        self.is_train = False
        super(MambaSISRModel, self).nondist_validation(dataloader, current_iter, tb_logger, save_img)
        self.is_train = True
