...
from VmambaIR.data.data_util import (paired_paths_from_folder,
                                    paired_DP_paths_from_folder,
                                    paired_paths_from_lmdb,
                                    paired_paths_from_meta_info_file)
from VmambaIR.data.transforms import augment, paired_random_crop, paired_random_crop_DP, random_augmentation
from VmambaIR.utils import FileClient, imfrombytes, img2tensor, padding, padding_DP, imfrombytesDP,scandir
...
class GaussianDenoisingPairedDataset(data.Dataset):
    ...
    def __init__(self, opt):
        super(GaussianDenoisingPairedDataset, self).__init__()
        self.opt = opt
