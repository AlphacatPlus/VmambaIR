...
class MambaRealSRGANtest(SRGANModel):
    """
    ...
    def __init__(self, opt):
        super(MambaRealSRGANtest, self).__init__(opt)
    ...
    def init_training_settings(self):
        train_opt = self.opt['train']
        super(MambaRealSRGANtest, self).init_training_settings()
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        self.is_train = False
        super(MambaRealSRGANtest, self).nondist_validation(dataloader, current_iter, tb_logger, save_img)
        self.is_train = True
    ...
    def optimize_parameters(self, current_iter):
        ...
        #self.output, pred_IPR_list = self.net_g(self.lq)
