...
class MambaRealSRGAN(SRGANModel):
    """
    ...
    def __init__(self, opt):
        super(MambaRealSRGAN, self).__init__(opt)
    ...
    def init_training_settings(self):
        train_opt = self.opt['train']
        super(MambaRealSRGAN, self).init_training_settings()
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        self.is_train = False
        super(MambaRealSRGAN, self).nondist_validation(dataloader, current_iter, tb_logger, save_img)
        self.is_train = True
